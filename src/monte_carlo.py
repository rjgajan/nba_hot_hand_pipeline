...
def count_hot_streaks(ppm_list: Iterable[float], threshold: float, window: int = 3) -> int:
...
def run_mc(ppm_list: Iterable[float], nsim: int, threshold: float = None, window: int = 3) -> Dict[str, float]:
